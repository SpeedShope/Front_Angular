...
export class AddProduittenderComponent implements OnInit{
...
onImageSelected(event: any) {
  ...
  add_Product(){
    ...
    this.productService.PostProducttender(formData,this.idtender).subscribe(
      response => {
